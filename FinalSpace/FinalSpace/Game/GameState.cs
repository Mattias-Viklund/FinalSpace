...
namespace FinalSpace.Game
{
    class GameState : StateBase
    {
        ...
        public override void Init()
        {
            ...
            planet = new Earth(planetTexture, 100, new Vector2f(Program._window.Size.X / 2, Program._window.Size.Y / 2));
            ...
            textbox = new TextBox(new Vector2f(Program._window.Size.X, 200), new Vector2f(0, Program._window.Size.Y-200), 50, 20, Color.Black);
